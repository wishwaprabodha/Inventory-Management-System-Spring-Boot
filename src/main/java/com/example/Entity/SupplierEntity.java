...
@Entity
@Table(name = "supplier", schema = "ipay")
public class SupplierEntity {
    ...
    private Collection<StockEntity> stocksBySupplierId;
    private Collection<StockLogEntity> stockLogsBySupplierId;
    ...
    public Collection<StockEntity> getStocksBySupplierId() {
        return stocksBySupplierId;
    }

    public void setStocksBySupplierId(Collection<StockEntity> stocksBySupplierId) {
        this.stocksBySupplierId = stocksBySupplierId;
    }

    @OneToMany(mappedBy = "supplierBySupplierId")
    public Collection<StockLogEntity> getStockLogsBySupplierId() {
        return stockLogsBySupplierId;
    }

    public void setStockLogsBySupplierId(Collection<StockLogEntity> stockLogsBySupplierId) {
        this.stockLogsBySupplierId = stockLogsBySupplierId;
    }
}
